         ...
         <Showing>
            <Container>
               <Menu>
                  ...
                  <Link to='/' onClick={() => props.setIsShowing(false)}> phim sắp chiếu</Link>
               </Menu>

               <ShowFilms>
                  {
                     ShowingFilmDatas.slice(0, 6).map(film => (
                        <Film key={film._id}>
                           <Avatar>
                              <img src={film.avatarSub ? film.avatarSub : film.avatar} alt={film.name} />
                              <Link to='/mua-ve'>MUA VÉ</Link>
                           </Avatar>
                           <h4>{film.name}</h4>
               ...
               <More>
                  <Link to='/phim-dang-chieu'>Xem Thêm <i className="fas fa-long-arrow-alt-right"></i></Link>
               </More>
